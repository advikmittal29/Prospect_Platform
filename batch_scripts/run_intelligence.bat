@echo off
:: ============================================================
::  Intelligence Pipeline - Task Scheduler Wrapper
:: ============================================================
...
set SCRIPT=%PROJECT_ROOT%\scheduler\run_intelligence.py
set LOG_DIR=C:\logs\scheduler
set LOG=%LOG_DIR%\intelligence.log

if not exist "%LOG_DIR%" mkdir "%LOG_DIR%"

echo. >> "%LOG%"
echo =============================== >> "%LOG%"
echo [%date% %time%] START intelligence >> "%LOG%"
echo =============================== >> "%LOG%"
